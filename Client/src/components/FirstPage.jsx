                    ...
                    <div className="bg-white shadow-md rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="p-6 bg-blue-500 rounded-lg text-center text-white">
                                ...
                                <button className="mt-4 bg-white text-blue-500 hover:bg-blue-100 px-6 py-3 rounded-md shadow-md transition-colors duration-300 ease-in-out focus:outline-none">
                                    Join
                                </button>
                            </div>
                            ...
                            <div className="p-6 bg-gray-200 rounded-lg text-center">
                                ...
                                <button className="mt-4 bg-blue-500 text-white hover:bg-blue-600 px-6 py-3 rounded-md shadow-md transition-colors duration-300 ease-in-out focus:outline-none">
                                    Log In
                                </button>
                            </div>
